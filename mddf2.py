...
parser.add_argument('-dsf', '--delStringFilename', action='store_true', help='Delete String in file remove(default: "remove.list") from target filename')
parser.add_argument('-ddf', '--delDateFilename', action='store_true',   help='Delete date string from target filename')
parser.add_argument('-dsd', '--delStringDirectory', action='store_true', help='Delete string in file remove(default: "remove.list") from target directory')
...
if args.sd:    
    ...
    move_files(src_folder,tar_folder,
               args.move_file,args.copy_file,args.create_folder,
